...
`@hasna/ui` is stateless at the package level. It has no dependency on shared
hosted synchronization packages; harvested ui.sh content is a user-managed
local mirror under `content/` and can be deleted or regenerated.
